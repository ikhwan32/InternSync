    ...
    <div class="dashboard-container">
        ...
        <div class="card" style="border-radius: 20px;">
            <div class="inner" style="padding-top: 20px;">
                ...
                <div style='font-weight: 500;'><br>Section A : Student Evaluation</div>
            </div>
                    <!------------- 16 dropdown Section ---------------->   
            <form action="submitDropdownSelection.jsp" method="POST">
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>1.Personality - way of dressing</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>2.Obey the organization rules (Attendance, determination meet office hours etc.) </div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>3.Ability to take responsibility</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>4.Implementation task / project given</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>5.Intelligence and ability in receive and increase knowledge and skills</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>6.Ability to receive instructions</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>7.Ability to work in a team</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>8.Adaptation on workplace</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>9.Self-confidence</div>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="b9" data-bs-toggle="dropdown" aria-expanded="false" style="width: 180px; border-radius: 10px;">
                            ${param.selectedStudent != null ? param.selectedStudent : 'Select Marks'}
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" onclick="selectb9('1')">1</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb9('2')">2</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb9('3')">3</a></li>                            
                            <li><a class="dropdown-item" href="#" onclick="selectb9('4')">4</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb9('5')">5</a></li>
                        </ul>
                    </div>
                    <input type="hidden" name="selectedb9" id="b9selected">
                </div>                               
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>10.Ability to translate task into logbook</div>
                    <div class="dropdown">
                        <button class="btn btn-secondary dropdown-toggle" type="button" id="b10" data-bs-toggle="dropdown" aria-expanded="false" style="width: 180px; border-radius: 10px;">
                            ${param.selectedStudent != null ? param.selectedStudent : 'Select Marks'}
                        </button>
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            <li><a class="dropdown-item" href="#" onclick="selectb10('1')">1</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb10('2')">2</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb10('3')">3</a></li>                            
                            <li><a class="dropdown-item" href="#" onclick="selectb10('4')">4</a></li>
                            <li><a class="dropdown-item" href="#" onclick="selectb10('5')">5</a></li>
                        </ul>
                    </div>
                    <input type="hidden" name="selectedb10" id="b10selected">
                </div>                                
                                                        
            <br><br><br>
                <!-------------  button Section ----------------> 
            <div class="card-outer" style="margin-bottom: 0px;">
                <a href="BLI06-1.jsp" class="btn btn-primary" style='background-color: #5D8BFF; border: none; flex-grow: 1;'>Back</a>
                <a href="bli06-3.jsp" type="submit" class="btn btn-primary" style='background-color: #00D072; border: none; flex-grow: 1;'>Next</a>
            </div>
            </form>
            ...
            <script>
                ...
                function selectb9(name) {
                    document.getElementById('b9').textContent = name;
                    document.getElementById('b9selected').value = name;
                }
                function selectb10(name) {
                    document.getElementById('b10').textContent = name;
                    document.getElementById('b10selected').value = name;
                }                 
            </script>
            ...
            <div class="container my-5">
                <nav>
                    <ul class="pagination d-flex justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="bli06-2.jsp" style="background-color: #5D8BFF; color: white; border: none; border-radius: 10px;">2</a></li>
                        <li class="page-item"><a class="page-link" href="bli06-3.jsp" style="border: none;">3</a></li>
                        </li>
                    </ul>
                </nav>
            </div>
