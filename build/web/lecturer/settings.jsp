<%-- 
    Document   : settings
    Created on : Dec 16, 2024, 6:37:07 PM
    Author     : Itqnazs
--%>
    ...
    <div class="dashboard-container">
        ...
        <div class="card" style="border-radius: 20px; padding: 0px;">
            <div class="subcard">
                <div class="subcard2">
                    <div class="subcard3">
                        ...
                        <span style="font-size: 20px; color: darkslategrey;">SUPERVISOR NAME</span>
                        <span>User_id</span>
                        <span>Academic Supervisor | University_Name</span>
                    </div>
            ...
            <div class="card-outer" style="margin-bottom: 40px;">
                <a href="../Logout.do" class="btn btn-primary" style='background-color: #FF6F6F; border: none; flex-grow: 1;'>Log Out</a>
