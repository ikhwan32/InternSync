    ...
    <div class="dashboard-container">
        ...
        <div class="card" style="border-radius: 20px;">
            <div class="inner" style="padding-top: 20px;">
                ...
                <div style='font-weight: 500;'><br>Information management skills and lifelong learning (LO7) - Report</div>
            </div>
                    <!------------- 16 dropdown Section ---------------->   
            <form action="submitDropdownSelection.jsp" method="POST">
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>1.Ability to independent to learn and get new information</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>2.Ability to find information that relevant from different source </div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>3.Ability to manage and access information</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>4.Open to new idea and ability to self-learn or autonomy</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>5.Ability to produce task that will give benefit to organization and community</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>6.Generate report comply to format, consistent content and use language that clear and easy to understand </div>
                    <div class="dropdown">
            ...
            <div class="card-outer" style="margin-bottom: 0px;">
                <a href="bli08-2.jsp" class="btn btn-primary" style='background-color: #5D8BFF; border: none; flex-grow: 1;'>Back</a>
                <a href="bli08-4.jsp" type="submit" class="btn btn-primary" style='background-color: #00D072; border: none; flex-grow: 1;'>Next</a>
            </div>
            </form>
            ...
            <div class="container my-5">
                <nav>
                    <ul class="pagination d-flex justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="bli08-1.jsp" style="border: none;">1</a></li>
                        <li class="page-item"><a class="page-link" href="bli08-2.jsp" style="border: none;">2</a></li>
                        <li class="page-item"><a class="page-link" href="bli08-3.jsp" style="background-color: #5D8BFF; color: white; border: none; border-radius: 10px;">3</a></li>
