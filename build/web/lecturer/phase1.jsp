...
<body class="bg-gray-50">
    <c:set var="page" value="phase1" scope="request" />
                    ...
                    <div class="flex items-center gap-4">
                        <div class="relative">
                            ...
                            <ul class="absolute hidden bg-white border border-gray-200 rounded-md shadow-lg mt-1 w-full z-10" id="dropdownMenu">
                                <li>
                                    <a href="phase1.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white" onclick="selectBLI('BLI01')">BLI01</a>
                                </li>
                                <li>
                                    <a href="phase1Bli02.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white" onclick="selectBLI('BLI02')">BLI02</a>
                                </li>
                            </ul>
                        </div>
