    ...
    <div class="dashboard-container">
        ...
        <div class="card" style="border-radius: 20px;">
            <div class="inner" style="padding-top: 20px;">
                ...
                <div style='font-weight: 500;'><br>Values, ethics, moral and professionalism(LO6) Report</div>
            </div>
                    <!------------- 16 dropdown Section ---------------->   
            <form action="submitDropdownSelection.jsp" method="POST">
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>1.Shows commitment for the task given</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>2.Understand their character to solve issues and problems on the task scope given </div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>3.Analyze and make decision to solve problem involving ethic issues </div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>4.Ability to independent to learn and get new information</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>5.Ability to find relevant information from different source</div>
                    <div class="dropdown">
            ...
            <div class="card-outer" style="margin-bottom: 0px;">
                <a href="bli08-3.jsp" class="btn btn-primary" style='background-color: #5D8BFF; border: none; flex-grow: 1;'>Back</a>
            ...
            <div class="container my-5">
                <nav>
                    <ul class="pagination d-flex justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="bli08-4.jsp" style="background-color: #5D8BFF; color: white; border: none; border-radius: 10px;">4</a></li>
                        </li>
                    </ul>
                </nav>
            </div>
