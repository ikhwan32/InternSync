                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900">BLI 02</h3>
                                    <p class="text-sm text-gray-600">Organization approval response form for internship</p>
                                    <a href="BLI02Servlet?studentName=${param.studentName}" class="mt-2 inline-block w-full bg-blue-500 text-white px-4 py-2 rounded-md text-center">Open</a>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
                            <div class="flex items-center gap-4">
                                <img src="<c:url value='/assets/images/thumbnail1.png'/>" alt="thumbnail" class="w-20 h-20 rounded-lg object-cover">
                                <div>
                                    <h3 class="text-lg font-semibold text-gray-900">BLI 05</h3>
                                    <p class="text-sm text-gray-600">Evaluation form for internship student</p>
                                    <a href="BLI05.jsp" class="mt-2 inline-block w-full bg-blue-500 text-white px-4 py-2 rounded-md text-center">Open</a>
                                </div>
                            </div>
                        </div>
                    </div>
