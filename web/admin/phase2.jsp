...
<body class="bg-gray-50 min-h-screen flex">
    <c:set var="page" value="phase2" scope="request" />
        ...
        <div class="p-8">
                ...
                <div class="flex items-center gap-4">
                    <div class="relative">
                        ...
                        <ul class="absolute hidden bg-white border border-gray-200 rounded-md shadow-lg mt-1 w-full z-10" id="dropdownMenu">
                            <li>
                                <a href="phase2.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-blue-500 hover:text-white" onclick="selectBLI('BLI03')">BLI03</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                <div class="bg-white rounded-xl shadow-sm p-6 text-center">
                    ...
                    <p class="text-2xl font-bold text-blue-500">${totalStudents1}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-6 text-center">
                    ...
                    <p class="text-2xl font-bold text-green-500">${totalCompleted1}</p>
                </div>
                <div class="bg-white rounded-xl shadow-sm p-6 text-center">
                    ...
                    <p class="text-2xl font-bold text-red-500">${totalUncompleted1}</p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm p-6">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        <h2 class="text-xl font-bold text-gray-900">PHASE 2</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody>
                            <c:forEach var="bli03" items="${phase2}">
                                <tr>
                                    <td class="px-4 py-2 border-b">${bli03.name}</td>
                                    <td class="px-4 py-2 border-b">${bli03.compName}</td>
                                    <td class="px-4 py-2 border-b">${bli03.phoneNum}</td>
                                    <td class="px-4 py-2 border-b">${bli03.email}</td>
                                    <td class="px-4 py-2 border-b">
                                        <button class="bg-blue-500 text-white px-4 py-1 rounded-md hover:bg-blue-600 transition-colors">Reopen</button>
                                    </td>
                                    <td class="px-4 py-2 border-b">
                                        <span class="${bli03.status == 'Completed' ? 'text-green-500' : 'text-red-500'} font-semibold">
                                            ${bli03.status}
                                        </span>
                                    </td>
                                </tr>
                ...
                <div class="mt-4 text-sm text-gray-600">
                    Showing data 1 to ${phase2.size()} of ${phase2.size()} entries
                </div>
            </div>
        </div>
    </div>
