    ...
    <div class="dashboard-container">
        ...
        <div class="card" style="border-radius: 20px;">
            <div class="inner" style="padding-top: 20px;">
                ...
                <div style='font-weight: 500;'><br>Thinking and scientific skills (LO3) - Logbook </div>
            </div>
                    <!------------- 16 dropdown Section ---------------->   
            <form action="submitDropdownSelection.jsp" method="POST">
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>1.Logbook internal notes tidiness</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>2.Student ability to translate daily/weekly assignment into logbook </div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>4.Overall logbook content</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>5.Checked by industrial supervisor from time to time</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>6.Ability to understand and explain the work scope concept</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>7.Ability to deliver the task concept clear and appropriate</div>
                    <div class="dropdown">
                ...
                <div class="card-outer" style="display: flex; justify-content: space-between; align-items: center;">
                    <div>8.Ability to use self-skills to deliver conclusion in the task given</div>
                    <div class="dropdown">
            ...
            <div class="card-outer" style="margin-bottom: 0px;">
                <a href="bli08-1.jsp" class="btn btn-primary" style='background-color: #5D8BFF; border: none; flex-grow: 1;'>Back</a>
                <a href="bli08-3.jsp" type="submit" class="btn btn-primary" style='background-color: #00D072; border: none; flex-grow: 1;'>Next</a>
            </div>
            </form>
            ...
            <div class="container my-5">
                <nav>
                    <ul class="pagination d-flex justify-content-center">
                        ...
                        <li class="page-item"><a class="page-link" href="bli08-2.jsp" style="background-color: #5D8BFF; color: white; border: none; border-radius: 10px;">2</a></li>
